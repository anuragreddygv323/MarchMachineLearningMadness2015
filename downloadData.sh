...
wget -x --load-cookies cookies.txt -P Data -nH --cut-dirs=5 http://www.kaggle.com/blobs/download/forum-message-attachment-files/1955/cities.csv
wget -x --load-cookies cookies.txt -P Data -nH --cut-dirs=5 http://www.kaggle.com/blobs/download/forum-message-attachment-files/1956/hosts.csv
wget -x --load-cookies cookies.txt -P Data -nH --cut-dirs=5 http://www.kaggle.com/blobs/download/forum-message-attachment-files/1957/team_conf_and_geog.csv
...
wget -x --load-cookies cookies.txt -P Data -nH --cut-dirs=5 http://www.kaggle.com/blobs/download/forum-message-attachment-files/1973/team_spellings.csv